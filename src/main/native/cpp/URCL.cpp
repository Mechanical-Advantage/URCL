...
void URCL::Start(std::map<int, std::string_view> aliases, bool withNT) {
  ...
  persistentLogEntry =
      wpi::log::RawLogEntry{frc::DataLogManager::GetLog(),
                            "/URCL/Raw/Persistent", "", "URCLr2_persistent"};
  periodicLogEntry =
      wpi::log::RawLogEntry{frc::DataLogManager::GetLog(), "/URCL/Raw/Periodic",
                            "", "URCLr2_periodic"};
  aliasesLogEntry = wpi::log::RawLogEntry{
      frc::DataLogManager::GetLog(), "/URCL/Raw/Aliases", "", "URCLr2_aliases"};
